.include "script_plat.s"

Script:
	script ev_common_board
	script Script_2
	script Script_3
	script Script_4
	script Script_5
...
ev_common_board: @ 2fc
	_switch 0x800c
	_case 0 Script_branch_33a
	_case 1 Script_branch_341
...
end_spray: @ 138c
	...
	CheckItem 0x800c 0x1 0x800d
	If 0x800d, 0x1
	CompareLastResultJump EQUAL have_repel
	Message 0x4f
	Cmd_30
	CloseMsgOnKeyPress
	ReleaseAll
...
have_repel:
	...
	YesNoBox 0x800c
	If 0x800c, 0x0
	CompareLastResultJump EQUAL, use_again
	If 0x800c, 0x1
	CompareLastResultJump EQUAL, repel_endof
	WaitButton
	CloseMsgOnKeyPress
	ReleaseAll
	End
...
use_again:
	...
	If 0x800c, MAX_REPEL
	CompareLastResultJump EQUAL, repel2
	If 0x800c, SUPER_REPEL
	CompareLastResultJump EQUAL, repel3
	jump repel_endof
